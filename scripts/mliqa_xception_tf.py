...
train_y_qual = df_train['mos'].tolist()
val_y_qual = df_val['mos'].tolist()
test_y_qual = df_test['mos'].tolist()
...
base_model = tf.keras.applications.Xception(input_shape=(IMG_SIZE,IMG_SIZE,CHANNELS),
                                               include_top=False,
                                               weights='imagenet')
